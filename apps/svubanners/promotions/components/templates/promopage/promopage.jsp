...
%><%@ page import="com.day.cq.wcm.api.WCMMode, com.day.cq.commons.Doctype, org.apache.commons.lang3.StringEscapeUtils" %><%
...
<head>
	...
	<link href="/etc/designs/svubanners/master/css/promoPage.css" rel="stylesheet" type="text/css">
