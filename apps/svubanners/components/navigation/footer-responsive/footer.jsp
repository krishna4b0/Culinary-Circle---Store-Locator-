...
<div id="footer">
    ...
    <div class="middle_row">
        ...
        <div class="column-1">
            ...
            <c:if test="${not empty footer.fbUrl and bannerSpecifier !='hornbachers'}">
                <a href="${footer.fbUrl }" target="_blank" title="Find us on Facebook">
            ...
            <a target="_blank" href="${footer.twUrl }" id="twitter-img">
                <img alt="" src="/etc/designs/svubanners/master/img/img-social-twitter.png" width="30" height="30">
            </a>
            </c:if>
            </div>
            <c:if test="${not empty footer.fbUrl and bannerSpecifier !='hornbachers'}">
    ...
    <div id="bottom_row">
        ...
        <li><a href="${footer.siteRoot }/about/careers.html" target="_top">Careers</a></li>
                ...
                <li><a href="${footer.siteRoot }/about/terms-and-conditions.html" class="ss-associates-link" target="_top">Associates</a></li>
            </ul>
