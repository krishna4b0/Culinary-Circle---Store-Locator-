...
<link rel="stylesheet" type="text/css" media="screen" href="<%=masterDesignPath %>/css/categorypage.css">
<c:if test="${not masterDesignSelected }">
<link rel="stylesheet" type="text/css" media="screen" href="<%=currentDesign.getPath() %>/css/categorypage.css">
</c:if>