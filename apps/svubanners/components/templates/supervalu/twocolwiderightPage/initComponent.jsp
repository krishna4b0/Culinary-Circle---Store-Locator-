...
--%><%@page session="false"
            ...
            import="com.svu.bannersites.cq5.components.templates.TwoColumnWideRightTemplate" %><%
%><%@taglib prefix="cq" uri="http://www.day.com/taglibs/cq/1.0" %><%
%><cq:defineObjects/>
<%
	TwoColumnWideRightTemplate template = new TwoColumnWideRightTemplate(pageContext);
