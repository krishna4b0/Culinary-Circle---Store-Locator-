...
<link rel="stylesheet" type="text/css" media="screen" href="<%=masterDesignPath %>/css/twocolumn.css">
<c:if test="${not masterDesignSelected }">
<link rel="stylesheet" type="text/css" media="screen" href="<%=currentDesign.getPath() %>/css/twocolumn.css">
</c:if>