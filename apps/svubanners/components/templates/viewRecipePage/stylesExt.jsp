...
<link rel="stylesheet" type="text/css" media="screen" href="<%=masterDesignPath %>/css/viewRecipePage.css">
<c:if test="${not masterDesignSelected }">
<link rel="stylesheet" type="text/css" media="screen" href="<%=currentDesign.getPath() %>/css/viewRecipePage.css">
</c:if>