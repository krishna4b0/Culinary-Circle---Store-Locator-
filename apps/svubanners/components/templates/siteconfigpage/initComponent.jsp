...
--%><%@page session="false"
            ...
            import="com.svu.bannersites.cq5.components.templates.SiteConfigurationTemplate" %><%
%><%@taglib prefix="cq" uri="http://www.day.com/taglibs/cq/1.0" %><%
%><cq:defineObjects/>
<%
	SiteConfigurationTemplate template = new SiteConfigurationTemplate(pageContext);
