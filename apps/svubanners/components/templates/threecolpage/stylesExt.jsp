...
<link rel="stylesheet" type="text/css" media="screen" href="<%=masterDesignPath %>/css/threecolumn.css">
<c:if test="${not masterDesignSelected }">
<link rel="stylesheet" type="text/css" media="screen" href="<%=currentDesign.getPath() %>/css/threecolumn.css">
</c:if>