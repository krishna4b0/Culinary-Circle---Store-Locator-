 ...
 */
SVU.widgets.Carousel = CQ.Ext.extend(CQ.form.Slideshow, {
    ...
    constructor: function(config) {
        ...
        var defaults = {
            ...
            "footPanel": new SVU.widgets.Carousel.TitlePanel({ }),
        ...
        SVU.widgets.Carousel.superclass.constructor.call(this, config);
    ...
    initComponent: function() {
    	SVU.widgets.Carousel.superclass.initComponent.call(this);
    },
    ...
    createSlide: function(data, slideIndex, basePath) {
        ...
        var path = (data ? data["path"] : null);
        var overlayLabel = (data ? data["overlayLabel"] : null);
        var tooltip = (data ? data["tooltip"] : null);
        ...
        if (data && fileRef) {
            ...
            if (referencedFileInfo) {
                slide = new SVU.widgets.Carousel.Slide({
...
//    },
    ...
    saveChanges: function() {
        if (this.editedSlide) {
            ...
            var path = this.footPanel.getPath();
            var overlayLabel = this.footPanel.getOverlayLabel();
            var tooltip = this.footPanel.getTooltip();
            this.editedSlide.referencedFileInfo = this.referencedFileInfo;
            this.editedSlide.title = (title ? title : null);
            this.editedSlide.path = (path ? path : null);
            this.editedSlide.tooltip = (tooltip ? tooltip : null);
            this.editedSlide.overlayLabel = (overlayLabel ? overlayLabel : "false");
    ...
    showSlide: function(slide) {
        ...
        this.footPanel.setPath(slide.path);
        this.footPanel.setTooltip(slide.tooltip);
        this.footPanel.setOverlayLabel(slide.overlayLabel);
...
// register xtype
CQ.Ext.reg('carousel', SVU.widgets.Carousel);