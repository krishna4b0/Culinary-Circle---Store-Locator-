...
/**
 * @class SVU.widgets.Carousel.Slide
 * @private
 ...
 */
SVU.widgets.Carousel.Slide = CQ.Ext.extend(CQ.Ext.emptyFn,  {
    ...
    createTransferFields: function(prefix) {
        ...
        if (!this.isDeleted) {
            ...
            var path  = basicName + "/path";
            var tooltip = basicName + "/tooltip";
            var overlayLabel = basicName + "/overlayLabel";
            if (this.referencedFileInfo) {
